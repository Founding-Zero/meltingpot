    ...
    "components": [
        {
            ...
            "kwargs": {
                "initialState": "grass",
                "stateConfigs": [
                    {"state": "grass", "layer": "background", "sprite": "Grass"},
                    {"state": "dessicated", "layer": "background", "sprite": "Floor"},
                ],
            },
        },
        {
        ...
        },
        {
            ...
            "kwargs": {
                ...
                "palettes": [
                    {"*": (158, 194, 101, 255), "@": (170, 207, 112, 255)},
                    {
                        "*": (220, 205, 185, 255),
                        "+": (210, 195, 175, 255),
                    },
...
def create_apple_prefab(
    regrowth_radius=-1.0,  # pylint: disable=dangerous-default-value
    ...
    for i in range(int(upper_bound_possible_neighbors)):
        growth_rate_states.append(
            dict(
                state="appleWait_{}".format(i),
                layer="logic",
...
def create_prefabs(
    ...
    prefabs["apple"] = create_apple_prefab(
        regrowth_radius=regrowth_radius, regrowth_probabilities=regrowth_probabilities
    )
    return prefabs
...
def get_config():
    ...
    config.individual_observation_names = ["RGB", "READY_TO_SHOOT", "LIVE_APPLE_COUNT"]
